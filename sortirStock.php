...
if (isset($_POST["valider"])) {
    ...
    {
    $req=$connexion->prepare("INSERT INTO sortie(`date`, article, quantite, client, utilisateur, statut) VALUES (?,?,?,?,?,?)");
    $req->execute(array($date,$article,$quantite,$client,$site,$statut));

    $mesg= "Enregistrement reussi";
    header("location:sortirStock.php?msg=$mesg");
    }
}
        ...
        <section class="section pt-5">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center">Enregistrer une Vente</h4>
                                    ...
                                    <div class="modal-content rounded-5 shadow">
                                        ...
                                        <div class="modal-body p-5 pt-0">
                                            ...
                                            <div class="form-floating mb-2">
                                                    ...
                                                    <label for="floatingInput"> total en stock</label>
                                            ...
                                            <div class="form-floating mb-3">	
                                                ...
                                                <?php if(isset($mesge)){
                                                    ...
                                                    ?>
                                                    <p class="text-danger text-center"><?php echo $mesge ; ?> </p>
                                                ...
                                                <button class="w-100 mb-2 btn btn-lg rounded-5 btn-outline-primary"
                                                    type="submit" name="valider"> Enregistrer</button> <br>
                                            </form>
                                        </div>
                                    </div>
                                </div>
