...
$iden=$_GET['iden'];
$req=$connexion->prepare("SELECT entree.date, article.designation, entree.quantite, planteur.nom, planteur.postnom,entree.id FROM `entree`,article,planteur WHERE article.id=entree.article AND planteur.idplan=entree.planteur AND entree.id='$iden'");
$req->execute();
$number=0;
$donnee=$req->fetch();
...
if (isset($_POST["valider"])) {
    ...
    $req=$connexion->prepare("UPDATE entree Set  article=?, quantite=?, planteur=? where id='$iden'");
    $req->execute(array($article,$quantite,$fournisseur));

    $mesg= "Modification reussi";
                                        ...
                                        <div class="modal-body p-5 pt-0">
                                            ...
                                            <div class="form-floating mb-3">	
                                                ...
                                                <div class="form-floating mb-3">	
                                                    ...
                                                    <option value=""><?php echo $donnee['nom']?></option>  
                                                        <?php 
